...
echo.>> "!XISO_SCRIPT!"
echo # Ensure PATH includes msys and mingw64 binaries>> "!XISO_SCRIPT!"
echo export PATH="/usr/bin:/mingw64/bin:$PATH">> "!XISO_SCRIPT!"
echo.>> "!XISO_SCRIPT!"
echo # Install cdrkit ^(provides genisoimage^) from msys repo>> "!XISO_SCRIPT!"
echo echo "Installing cdrkit ^(provides genisoimage^)...">> "!XISO_SCRIPT!"
echo pacman -S --noconfirm --needed cdrkit>> "!XISO_SCRIPT!"
echo.>> "!XISO_SCRIPT!"
echo # Change to project directory>> "!XISO_SCRIPT!"
echo cd "%cd:\=/%">> "!XISO_SCRIPT!"
echo.>> "!XISO_SCRIPT!"
echo # Create the ISO using genisoimage>> "!XISO_SCRIPT!"
...
echo.>> "!XISO_SCRIPT!"
echo # genisoimage is in /usr/bin>> "!XISO_SCRIPT!"
echo /usr/bin/genisoimage -o "!OUTPUT_MSYS!" -iso-level 4 -R -J "!ISO_DIR_MSYS!">> "!XISO_SCRIPT!"
echo.>> "!XISO_SCRIPT!"
